...
- Reliability patterns: transactional Outbox, Saga with compensation, Dead-Letter Queue
...
- [`notebooks/04_reliability_patterns.ipynb`](./notebooks/04_reliability_patterns.ipynb) — Production reliability: the transactional Outbox for the dual-write problem, Sagas with compensation for multi-step workflows, and Dead-Letter Queues for poison messages.
